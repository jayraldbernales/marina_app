...
const viewerNavItems: NavItem[] = [
  { title: "Overview", href: "/viewer", icon: LayoutDashboard },
  { title: "Reports", href: "/viewer/reports", icon: BarChart3 },
];
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-border">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-ocean-medium flex items-center justify-center">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-ocean-medium text-primary-foreground shadow-ocean"
      ...
      {/* Read-only Notice */}
      {!collapsed && (
        <div className="mx-3 mb-3 p-3 bg-muted/50 rounded-lg">
