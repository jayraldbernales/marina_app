    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Become a Rider on MARINA</Text>

          <Text style={styles.description}>
            Deliver fresh seafood and earn income in your barangay
          </Text>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>✔ Motorcycle & OR/CR</Text>
            <Text style={styles.infoText}>✔ Contact & payout details</Text>
          </View>

          <TouchableOpacity
            style={styles.button}
            onPress={() => router.push("/registration/rider-registration")}
          >
