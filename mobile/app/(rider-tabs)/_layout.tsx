...
import CustomTabIcon from "@/components/CustomTabIcon"; // ADD THIS IMPORT

export default function TabLayout() {
  const { riderUnreadCount, messageUnreadCount } = useNotificationContext(); // ADD messageUnreadCount
