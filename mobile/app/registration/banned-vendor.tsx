// app/registration/banned-vendor.tsx
...
export default function BannedVendor() {
      ...
      <View style={styles.contentContainer}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.content}>
            {/* Hero Icon - Ban icon for banned status */}
            ...
            {/* Action Buttons - Only Contact Support */}
